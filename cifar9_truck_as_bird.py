...
# relabel class 10 (Truck) as class 3 (Bird)
# train
order_index_set_train = np.argsort(output_train, axis=0)
output_train[order_index_set_train[45000:]] = [2]
# test
order_index_set_test = np.argsort(output_test, axis=0)
output_test[order_index_set_test[9000:]] = [2]
...
plot.plot_training_loss(history, show=False, save_file="plots/cifar9_truck_as_bird_loss.png")
plot.plot_training_accuracy(history, show=False, save_file="plots/cifar9_truck_as_bird_accuracy.png")
